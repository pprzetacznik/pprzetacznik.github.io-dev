...
# Look how well elephants hide in a rowan tree

More often I see GitHub Copilot tutorials with prompts like _"Write unit tests for this function"_, closer I'm to fine about my job security.
...
Write tests before the implementation, use stubs over mocks, and always return something from your functions. I assure you, you'll have fewer side effects, you'll have to check internal behavior less often, your tests will be easier to maintain in the long term, and you'll save more time.
